    ...
    <section className="min-h-screen bg-[#f8f9fa] py-8 px-4 font-sans sm:px-6">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mt-0.5">
                Género: <span className="text-gray-600">{club.generoLiterario}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* COLUMNA IZQUIERDA: CONTENIDO Y DINÁMICA (2/3 de ancho) */}
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* ESPACIO RESERVADO: PRÓXIMAMENTE PRÓXIMAS LECTURAS, FOROS O ACTIVIDADES */}
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-2xs">
              <h2 className="text-xs font-bold uppercase tracking-widest text-[#2c3e50] mb-3 pb-2 border-b border-gray-50">
                Bitácora de Lectura
              </h2>
          ...
          {/* COLUMNA DERECHA: ADMINISTRACIÓN Y COMUNIDAD (1/3 de ancho) */}
          <div className="space-y-6">
            ...
            {/* ESPACIO RESERVADO: PRÓXIMAMENTE LISTA DE MIEMBROS O PARTICIPANTES */}
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-2xs">
              <div className="flex items-center gap-2 mb-4 pb-2 border-b border-gray-50 text-[#2c3e50]">
